...
.then(data =>{
    ...
    data.forEach(product => {
      ...
      <div class="Before_the_start">
       ...
       <iframe autoplay; encrypted-media" allowfullscreen="true" frameborder="0" height="100%" scrolling="1" muted
          src="${product.iframe}" 
...
{/* <iframe allow="autoplay; encrypted-media" allowfullscreen="true" class="" height="620px" id="streamFrame" rameborder="0" src="https://pl.buzkora.site/albaplayer/bein3/?serv=0" width="100%"></iframe> */}

{
  /* <iframe width="560" height="315"  */}
// src="https://www.youtube.com/embed/54t6fPzntWQ?si=rHBIhTV1ZgJcSg90"
